...
def initModel(model_yml = "model.yaml", weights = "model.h5"):
    ...
    if exists(model_yml, weights):
        ...
        model = k.model_from_yaml(yaml_model)
...
'''
	Permite modificar el tamaño de las matrices de entradas de la red
'''
...
'''
	...
	@param 	input1	primer parametro de entrada a la red, contiene la fotografía
