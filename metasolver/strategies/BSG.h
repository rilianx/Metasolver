...
public:
	 ...
	 */
	BSG(ActionEvaluator* evl, SearchStrategy& greedy, int beams, double p_elite=0.0, int max_level_size=0, bool plot=false, double aco_alpha=0.0, double aco_beta=0.0, tau_matrix* tauM=NULL) :
		SearchStrategy(evl, aco_alpha, aco_beta, tauM), greedy(greedy), beams(beams),
